...
int DeletePresenter(Element *dead){
	...
	if(delnode(FindPresenter((((Presenter*)(dead->obj))->pn),((List*)FindInCats(((Presenter*)(dead->obj))->pn))),((List*)FindInCats(((Presenter*)(dead->obj))->pn))))return 1;
	return 0;
}
...
int DeletePresentation(Element *dead){
	...
	if(delnode(FindPresentation(((Presentation*)(dead->obj))->pn,FindInCats(((Presentation*)(dead->obj))->pn)),FindInCats(((Presentation*)(dead->obj))->pn)))return 1;
	return 0;
}
